...
"This project aims to integrate [HTM.java](https://github.com/numenta/htm.java)
with the [Numenta Anomaly Benchmark (NAB)](https://github.com/numenta/NAB).

HTM.java-NAB is written in Clojure.
"

(defn fail [] (is (= 0 1)))


(facts "Creating simple Networks"
(let [network (create-network "test" default-parameters)
      ...
      (do
        ...
        (-> network (reset-it!) (lookup-in ["r1" "l1"]) (. hasTemporalMemory)))) => true
    (let [network (create-network "test" default-parameters)
          sp (spatial-pooler)
          layer (create-layer "l1" default-parameters)
          region (create-region "r1")]
      (do
        ...
        (-> network (reset-it!) (lookup-in ["r1" "l1"]) (. hasTemporalMemory)))) => false
)
